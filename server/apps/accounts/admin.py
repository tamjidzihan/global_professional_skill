...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'full_name_display', 'role', 'email_verified', 'is_active', 'date_joined')
    ...
    fieldsets = (
        ...
        ('Personal Info', {'fields': ('first_name', 'last_name', 'bio', 'profile_picture', 'phone_number')}),
...
class InstructorRequestAdmin(admin.ModelAdmin):
    ...
    list_display = ('user_email', 'user_name', 'status', 'created_at', 'reviewed_by', 'reviewed_at')
    ...
    fieldsets = (
        ...
        ('Request Details', {'fields': ('reason', 'qualifications', 'teaching_interests')}),
