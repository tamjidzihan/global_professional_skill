                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                        ...
                        <div className={card}>
                            <div className={cardHeader}>
                                ...
                                <div className='flex items-center gap-2 flex-wrap'>
                                    ...
                                    <button
                                        onClick={() => navigate(`/dashboard/admin/courses/${id}/coordinators`)}
                                    ...
                                    >
                                        <UserCheck className="w-3.5 h-3.5 text-blue-600" />Coordinators ({selectedCourse.coordinators?.length || 0})
                                    </button>
                                    <button
                    ...
                    <div className="space-y-5">
                        ...
                        <div className={card}>
                            <div className={cardHeader}>
                                <div>
                                    <p className={sectionTitle}>Course Coordinators</p>
                                    <p className={sectionSub}>Additional instructors assisting this course</p>
                                </div>
                                <div className={iconBox('bg-blue-50')}>
                            ...
                            <div className={cardBody}>
                                {selectedCourse.coordinators && selectedCourse.coordinators.length > 0 ? (
                                    <div className="space-y-3 mb-4">
                                        {selectedCourse.coordinators.map((coordinator: any) => (
                                            <div key={coordinator.id} className="flex items-center gap-3 p-2.5 bg-gray-50 rounded-xl border border-gray-100">
                                    ...
                                    <div className="text-center py-5 border border-dashed border-gray-200 rounded-xl bg-gray-50/50 mb-4">
                                        <Users className="w-6 h-6 text-gray-300 mx-auto mb-1.5" />
                                        <p className="text-xs font-semibold text-gray-600">No Coordinators Assigned</p>
                                        <p className="text-[10px] text-gray-400">Add other instructors to coordinate this course</p>
                                    </div>
                                )}

                                <button
                                    onClick={() => navigate(`/dashboard/admin/courses/${id}/coordinators`)}
                                    className="w-full flex items-center justify-center gap-1.5 py-2 px-3 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-lg text-xs font-semibold transition-colors cursor-pointer"
                                >
                                    <UserCheck className="w-3.5 h-3.5" /> Manage Course Coordinators ({selectedCourse.coordinators?.length || 0})
                                </button>
                            </div>
                        </div>
